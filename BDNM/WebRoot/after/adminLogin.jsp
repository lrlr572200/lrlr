	...
	<body>
		<div id="div">
			<div id="up">
				<table>
					<tr>
						...
						<td id="p" width="100px"><img id="t2" src="img/denglu/jietu31.png" height="25px">&nbsp;&nbsp;&nbsp;<span>管理员登录</span></td>
			...
			<div id="middle">
				...
				<div id="right">
				<form action="<%=request.getContextPath() %>/UserServlet?userSign=adminUserLogin" method="post">
						<table height="290px" width="300px" border="0" cellpadding="0" cellspacing="0" >
							<tr >
								<td>&nbsp;&nbsp;&nbsp;<span style="font-size: 17px; color: #666666;" id="dl"><strong>请输入管理员的账号和密码</strong></span><br><br><span>&nbsp;&nbsp;&nbsp;${display }</span></td>
							</tr>
							<tr style="margin-bottom: 30px;">
								<td id="imgb"><div><input type="text" id="text" name="userNameSign" placeholder="管理员账户" style="color: #DBDBDB;" /></div>
								</td>
							</tr>
							<tr style="margin-top: 10px;">
								<td id="imgc"><div><input type="password" id="password" name="pwdSign" placeholder="管理员密码"></div>
								</td>
							</tr>
							<tr>
								<td>&nbsp;
